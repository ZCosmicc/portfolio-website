...
function App() {
  ...
  const projects: Project[] = [
    ...
    /* 
    {
      ...
      description: "Full-stack e-commerce with payment gateway integration and real-time inventory management.",
    ...
    },
    {
      ...
      description: "Real-time collaboration tool for team productivity with drag-and-drop functionality.",
                  ...
                  <div className="absolute inset-0 bg-black/40 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                    <a 
                      ...
                      onClick={(e) => {
                        if (!project.demo) {
                          e.preventDefault();
                          addToast(`Coming soon! No demo available for ${project.title}`, 'info');
                        }
                      }}
